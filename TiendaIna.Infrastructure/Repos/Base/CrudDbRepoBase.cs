...
public abstract class CrudDbRepoBase<TEntity, TKey> : BaseRepository<TEntity, SqlConnection>, ICrudRepo<TEntity, TKey> where TEntity : class, IEntity<TKey> where TKey : notnull {
    ...
    public Task<IEnumerable<TEntity>> GetAsync() => QueryAllAsync();
